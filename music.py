...
class SetUI(object):
    ...
    def set_ui(self):
        ...
        file_menu.add_command(label='使用说明cluo', command=lambda: webbrowser.open('www.cluo.com'))
        file_menu.add_command(label='关于作者cluo', command=lambda: webbrowser.open('www.cluo.com'))
        ...
        passageway_button_1 = tk.Radiobutton(frame_1, text='酷我cluo', variable=self.ui_var, value=1, width=10, height=3)
        passageway_button_2 = tk.Radiobutton(frame_1, text='网易云cluo', variable=self.ui_var, value=2, width=10, height=3)
        passageway_button_3 = tk.Radiobutton(frame_1, text='QQ音乐cluo', variable=self.ui_var, value=3, width=10, height=3)
        passageway_button_4 = tk.Radiobutton(frame_1, text='酷狗cluo', variable=self.ui_var, value=4, width=10, height=3)
